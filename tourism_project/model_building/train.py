...
def main():
    ...
    # 5. Define ML pipeline: preprocessing + model
    pipeline = Pipeline(
        steps=[
    ...
    # 6. Define hyperparameter combinations to test
    param_grid = {
    ...
    # 7. Configure MLflow local experiment tracking
    mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)
    mlflow.set_experiment(EXPERIMENT_NAME)

    with mlflow.start_run():
        # Log basic dataset details
        ...
        # 8. Tune the model using F1 score as the selection metric
        ...
        # 11. Log best parameters and test metrics to MLflow
        ...
        # 12. Save model locally for deployment
